    ...
    return React.createClass({
      ...
      render: function () {
        ...
        var children = this.props.children && this.props.children.map(function (child, index) {
          ...
          var draggedClass = isDragged ? (className ? className + ' dragged' : 'dragged') : className;
        ...
        if (this.state.placedIndex >= 0 && draggedElement) {
          var placeholder = React.cloneElement(
            draggedElement,
            {
              ...
              className: draggedElement.props.className ? draggedElement.props.className + ' placeholder' : 'placeholder'
            }
          );
