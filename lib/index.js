      ...
      autoScroll: function () {
        ...
        if (this.props.lock !== 'horizontal') {
          if (scrollLeft > 0 && this.mouseOffset.clientX <= rect.left + scrollAreaX) {
            scrollMultiplier = Math.min(Math.abs(rect.left + scrollAreaX - this.mouseOffset.clientX), scrollAreaX) / scrollAreaX;
          ...
          if (scrollLeft < scrollWidth - rect.width && this.mouseOffset.clientX >= rect.right - scrollAreaX) {
            scrollMultiplier = Math.min(Math.abs(rect.right - scrollAreaX - this.mouseOffset.clientX), scrollAreaX) / scrollAreaX;
        ...
        if (this.props.lock !== 'vertical') {
          if (scrollTop > 0 && this.mouseOffset.clientY <= rect.top + scrollAreaY) {
            scrollMultiplier = Math.min(Math.abs(rect.top + scrollAreaY - this.mouseOffset.clientY), scrollAreaY) / scrollAreaY;
          ...
          if (scrollTop < scrollHeight - rect.height && this.mouseOffset.clientY >= rect.bottom - scrollAreaY) {
            scrollMultiplier = Math.min(Math.abs(rect.bottom - scrollAreaY - this.mouseOffset.clientY), scrollAreaY) / scrollAreaY;
