        ...
        var children = this.props.children && this.props.children.map(function (child, index) {
          ...
          return React.cloneElement(
            child,
            {
              ...
              onMouseMove: self.onItemMove.bind(self, child.props.onMouseMove, index),
              onTouchMove: self.onItemMove.bind(self, child.props.onTouchMove, index)
            }
          );
        }.bind(this));
